...
const Why_travellers_love_it = [
  "Best option for short layovers",
  "Zero stress — airport pickup & return included",
  "Authentic local food and harbor scenery",
            ...
            <div className="space-y-6" style={{animation: 'slide-in 0.6s ease-out'}}>   
              <div className="grid gap-4 text-left max-w-2xl">
                <div className="flex items-center gap-3">                      
                  <p className="text-slate-700 text-lg max-w-2xl leading-relaxed mb-6">Have six hours between flights at Seattle-Tacoma Airport? Instead of waiting inside the terminal, turn your stopover into a relaxing mini-adventure. Our 6-Hour Layover Tour is perfectly timed to let you experience Seattle’s most famous sights<br /> — with a guaranteed on-time return to the airport.</p>
                </div>  
              </div>
                ...
                <div className="rounded-3xl bg-white/80 backdrop-blur shadow-lg border border-white/50 p-8 hover-lift">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed">See the fish-toss show, browse local crafts, taste snacks, and visit the original Starbucks.</p>
                    </div>
                  </div>
                </div>
                <div className="rounded-3xl bg-white/80 backdrop-blur shadow-lg border border-white/50 p-8 hover-lift">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-purple-600 font-semibold mb-2"></p>
                      <p className="text-slate-600 text-sm leading-relaxed">Walk along Elliott Bay, spot ferries, and enjoy skyline and mountain views with a coffee or ice cream.</p>
                    </div>
                  </div>
                </div>              
              </div>
        ...
        <section className="py-16 ">
          <div className="container text-center">
            ...
            <p className="text-slate-600 text-lg mb-8 max-w-2xl mx-auto">
              Flights are monitored in real time and routes include built-in buffer time for traffic and airport security. You’ll return to SEA at least two hours before boarding — guaranteed.
            </p>
          ...
          <div className="container">
            <div className="text-center mb-16">
              ...
              <div className="text-lg text-slate-600 max-w-4xl mx-auto leading-relaxed ">
                Your Layover Concierge will meet guests at their arrival gate, or as close as possible, inside SEA-Tac Airport. Before landing, you’ll receive a WhatsApp message with your guide’s name, photo, and live location link for easy coordination.
              </div>
            </div> 
        ...
        <section className="py-16 bg-gradient-to-br from-purple-600 to-indigo-600">
          <div className="container text-center">
            ...
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              Book now at sixhourlayover.com or message us on WhatsApp for quick coordination.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href="/book"
