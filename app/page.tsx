        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="container mb-16">
              <div className="flex flex-wrap justify-center gap-4">
                <a href="/contact" className="inline-flex items-center px-8 py-3 bg-white text-color-heading font-bold text-lg rounded-xl shadow-2xl border-2 border-color-primary hover:shadow-3d transform hover:-translate-y-1 transition-all duration-300">
